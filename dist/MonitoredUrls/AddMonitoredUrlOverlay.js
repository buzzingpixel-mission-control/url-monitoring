...
var AddMonitoredUrlOverlay = function (_a) {
    ...
    var mutation = (0, MonitoredUrlData_1.useAddMonitoredUrlMutation)();
    ...
    return (react_1.default.createElement(buzzingpixel_mission_control_frontend_core_1.EditorShellFloating, { title: "Add New Monitored URL", isSaving: isSaving, submitButtonText: "Add", errorMessage: errorMessage, saveHandler: function () {
...
exports.default = AddMonitoredUrlOverlay;
